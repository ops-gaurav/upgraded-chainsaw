...
(function (){
	...
	function productsListController ($scope, $rootScope, $http, $log, PaginationService) {
	...
	function ordersListController ($scope, $rootScope, $http, PaginationService) {
	...
	function editUserController ($scope, $rootScope, $http, $log, $state, Upload, $window) {
	...
	function userController ($scope, $rootScope, $http, $log, $window, Upload) {
